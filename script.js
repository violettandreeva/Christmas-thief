...
const dialogSteps = {
  ...
  9: ["Прошла почти треть месяца, так держать! Единственное что ты делаешь настолько последовательно, это грабишь мои запасы, ну что рад? Глубже моего разочарования в своей силе, только твой следующий подарок. Если отгадаешь загадку, конечно же:", "Загадка: На ней звезда, снежок, узор, Для чая созданный прибор. Ищи её, но не в углу, Она укрылась… где? В шкафу!", "Ну все, иди искать!"],
  9: ["", "", ""],
};
